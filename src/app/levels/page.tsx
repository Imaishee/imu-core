...
import { Lock, Star, Zap, Trophy, BookOpen, Brain, Target } from "lucide-react";
...
export default function LevelsPage() {
  ...
  const isUnlocked = (levelId: number) => {
    return userXP >= levels.find((l) => l.id === levelId)!.xpRequired;
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 p-4 md:p-8">
      ...
      >
        ...
        <motion.div
          ...
          className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${levels[currentLevel - 1].color} p-8 mb-8 shadow-2xl`}
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mt-6">
              ...
              <p className="text-white/60 text-sm mt-2 text-center">
                {getNextLevelXP() - userXP} XP to next level
              </p>
            </div>
          </div>
        </motion.div>
              ...
              <motion.div
                ...
                className={`relative rounded-2xl p-4 ${
                  unlocked
                    ...
                    : "bg-gray-200"
                } ${isCurrent ? "ring-4 ring-white ring-offset-2" : ""}`}
              >
                {!unlocked && (
                ...
                <div className="text-center">
                  ...
                  <p
                    className={`text-xs mt-1 ${
                      unlocked ? "text-white/80" : "text-gray-400"
                    }`}
                  >
                    {level.xpRequired} XP
                  </p>
                  <p
                    className={`text-xs mt-2 ${
                      unlocked ? "text-white/60" : "text-gray-400"
                    }`}
                  >
                    {level.unlockFeature}
                  </p>
